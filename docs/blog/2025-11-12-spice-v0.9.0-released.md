...
```kotlin
// ✅ NEW: Native types with null safety
...
```kotlin
// ✅ EXCELLENT: Safe accessor with default
val userId = comm.getDataAsString("userId") ?: "anonymous"
...
// ❌ BAD: Unsafe cast (runtime exception risk)
...
comm.withData("optional", null)  // ✅ Valid
...
Happy coding with Spice 0.9.0! 🌶️
